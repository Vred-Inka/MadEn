...
{    
    try
    {
        ...
        cb_ps_light.data.MatAmbient = mLandMat.Ambient;
        cb_ps_light.data.MapDiffuse = mLandMat.Diffuse;
        cb_ps_light.data.MapSpecular = mLandMat.Specular;
        cb_ps_light.data.MapReflect = mLandMat.Reflect;
